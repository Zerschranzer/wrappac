...
class SettingsDialog(QDialog):
    ...
    def _build_root_tab(self) -> QWidget:
        ...
        # Additional option
        self.root_ask = QCheckBox(tr("settings_root_always_ask"))
        self.root_ask.setStyleSheet("font-weight: bold;")
        layout.addWidget(self.root_ask)
    ...
    def _load_values(self):
        ...
        self.root_ask.setChecked(settings.get("root_always_ask", False))
    ...
    def _save_and_close(self):
        ...
        settings.set("root_always_ask", self.root_ask.isChecked())
