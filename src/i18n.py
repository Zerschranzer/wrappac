...
TRANSLATIONS = {
    "de": {
        ...
        "msg_sudo_prime": "== sudo-Credentials werden validiert – das Passwort wird einmalig für alle Root-Schritte abgefragt ==",
    ...
    "en": {
        ...
        "msg_sudo_prime": "== Validating sudo credentials – the password is asked once for all root steps ==",
